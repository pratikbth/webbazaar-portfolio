      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto flex flex-col items-start text-left">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
          ...
          <a
            href="/resume.pdf"
            download
            className="px-8 py-4.5 rounded-2xl bg-white/10 border border-white/20 text-white hover:bg-white/20 font-bold hover:scale-105 active:scale-95 transition-all duration-200 flex items-center justify-center gap-2 backdrop-blur-md"
          >
            <svg className="w-5 h-5 text-webbazaar-saffron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
